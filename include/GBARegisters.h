...
#define REG_DISPCNT             *((vu16*)(REG_BASE + 0x0000)) // 0x04000000
    ...
    // Bit 5 | Allow access to OAM in an HBlank. OAM is normally locked in VDraw, reduces amount of sprite pixels rendered per line
    // Bit 6 | Object mapping mode, tells if the next row of tiles lies beneath the previous in a matrix
    // Bit 7 | Forces a screen blank
    // Bits 8-B | Enables rendering of Backgrounds 0-3
    // Bit C | Enables rendering of Sprites
